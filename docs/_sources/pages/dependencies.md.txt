...
|所属社区|[`mindspore`](https://www.mindspore.cn/docs/zh-CN/master/index.html)|深度学习框架|
|所属社区|[`mindinsight`](https://www.mindspore.cn/api/en/master/index.html)|mindspore可视化组件|
|所属社区的第三方依赖|[`google.protobuf`](https://developers.google.com/protocol-buffers)|数据结构序列化协议|
